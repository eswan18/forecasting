        ...
        ? <>
          <DropdownMenu>
            <DropdownMenuTrigger className="flex items-end gap-2 text-sm">
              <User2 size={22} className="pb-0.5" /><span className="hidden lg:inline">{user.user.name}</span>
            </DropdownMenuTrigger>
            <DropdownMenuContent>
              <DropdownMenuLabel className="lg:hidden">Logged in as {user.user.name}</DropdownMenuLabel>
              <DropdownMenuItem>
                <LogoutButton />
              </DropdownMenuItem>
            </DropdownMenuContent>
